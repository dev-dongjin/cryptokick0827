                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
				    ...
				    <c:if test="${not empty sessionScope.userid}">
						<button class="navbar-btn nav-button wow bounceInRight login"
							...
							Out</button>
						<button class="navbar-btn nav-button wow bounceInRight login"
							onclick="location.href='profile'" data-wow-delay="0.4s">Profile</button>
                    ...
                    <ul class="main-nav nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown ymm-sw" data-wow-delay="0.1s">
                            ...
                            <ul class="dropdown-menu navbar-nav">
                                ...
                                <li>
                                    <a href="Projects?product_category=Technology">Technology</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="Projects?product_category=Performance">Performance</a>
                                </li>
                                <li>
                                    <a href="Projects?product_category=Food">Food</a>
                                </li>
                                <li>
                                    <a href="Projects?product_category=Fashion">Fashion</a>
                                </li>
                                <li>
                                    <a href="Projects?product_category=Others">Others</a>
                                </li>
                            </ul>
                        </li>
