...
<body>
	...
	<!-- Body content -->
    <c:if test="true"><h2>${sessionScope.userid}</h2></c:if>
					...
					<form action="" method="">
						...
						<div class="clear">
							...
							<div class="col-sm-6" style="text-align: center;">
								<div class="form-group">
									<button type="button" onclick="location.href='memberSignIn'" class="btn btn-primary">
							...
							<div class="col-sm-6" style="text-align: center;">
								<div class="form-group">
									<button type="button" onclick="location.href='companySignIn'" class="btn btn-primary">
