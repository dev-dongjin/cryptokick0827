            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    <div class="button navbar-right">
                        <button class="navbar-btn nav-button wow bounceInRight login" onclick=" window.open('submit-property.html')" data-wow-delay="0.4s">Login</button>
                        ...
                        <div class="row">
                            <div class="light-slide-item">            
                                 <div class="clearfix">
									...
									<!-- 유투브 동영상 넣기 test -->
									<div id="player" class="content-media content-media--video" style="width: 720px; height: 405px; margin-bottom: 50px;"></div>
