		...
		<div class="container" style="margin-left: 400px;">
			<div class="col-md-6">
				<div class="box-for overflow">
					<div class="col-md-12 col-xs-12 login-blocks" id="member" style="width: 50%;">Member</div>
					<div class="col-md-12 col-xs-12 login-blocks" id="company" style="width: 50%;">Company</div>
					...
					<div class="col-md-12 col-xs-12 login-blocks" id="companyLogin">
						...
						<form action="companyLogIn" method="post">
							<div class="form-group">
								<label for="userid">ID</label> <input type="text"
									class="form-control" id="co_id" name="co_id">
							</div>
							<div class="form-group">
								<label for="password">Password</label> <input type="password"
									class="form-control" id="co_pwd" name="co_pwd">
							</div>
							<div class="text-center">
								<button type="submit" class="btn btn-default">Company LogIn</button>
							</div>
						</form>
					</div>
				</div>
