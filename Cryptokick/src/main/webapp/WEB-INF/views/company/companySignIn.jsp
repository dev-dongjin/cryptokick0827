		...
		<div class="container">
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1 profiel-container">
					...
					<form action="signIn2" method="post" enctype="multipart/form-data">
						<div class="profiel-header">
							<h3>
								<b>Enterprise</b> join membership <br> <small>This
							...
							<div class="col-sm-3 padding-top-25">
								...
								<div class="form-group">
									<label>Company ID <small>(required)</small></label> <input
										id="co_id" name="co_id" type="text" class="form-control"
										placeholder="apple...">
								</div>
								<div class="form-group">
							...
							<div class="col-sm-3 padding-top-25">
								...
								<div class="form-group">
									<label>Confirm password : <small>(required)</small></label> <input
										type="password" class="form-control" id="co_pwd2">
								</div>
								<div class="form-group">
						...
						<div class="clear">
							...
							<div class="col-sm-5 col-sm-offset-1">
								<div class="form-group">
									<label>CEO First Name :</label> <input name="co_ceo_firstname"
										type="text" class="form-control">
								</div>
								<div class="form-group">
									<label>CEO Last Name :</label> <input name="co_ceo_lastname"
										type="text" class="form-control">
								</div>
								<div class="form-group">
            ...
            <option data-title="Vietnam" value="Vietnam">Vietnam</option></select>
						...
						<div class="col-sm-5 col-sm-offset-1">
							...
							<button type="submit" class="btn btn-default"
								onsubmit="return formcheck()">Register</button>
						</div>
						<br>
					</form>
